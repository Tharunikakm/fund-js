        ...
        <Card sx={{ maxWidth: 345 }}>
          <CardActionArea >
            <CardMedia
              component="img"
              height="50"
              src="https://tse2.mm.bing.net/th?id=OIP.taMxx66aEknrfyFmv3O2NgHaE3&pid=Api&P=0&h=220"
              display="flex"
        ...
        <Card sx={{ maxWidth: 345 }} >
          <CardActionArea>
            <CardMedia
              component="img"
              height="140"
              src="https://media.istockphoto.com/id/1213370925/photo/adult-and-child-hands-holding-word-donate-donation-and-charity-concept.jpg?s=1024x1024&w=is&k=20&c=Om316ufIozJihaKUYHcfR8h_0dhC27ZLXJNGMppUvws="
              style={{ objectFit: "cover" ,height:300}}
            />
            <CardContent>
              <Typography gutterBottom variant="h5" component="div">
